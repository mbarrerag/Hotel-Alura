...
public class SuccesesfulRegisteration extends JDialog {
	...
	public static void main(String[] args) {
		try {
			SuccesesfulRegisteration dialog = new SuccesesfulRegisteration();
	 ...
	 * Create the dialog.
	 */
	public SuccesesfulRegisteration() {
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel.setIcon(new ImageIcon("src/main/java/org/example/imgs/Ha-100px.png"));
